...
def manage_students():
    # your code here
    students = ["Alice", "Bob", "Charlie", "David", "Billy", "Eve"]
...
def combine_foods():
    # your code here
    foods = ("pizza", "salad", "pasta", "burger", "rice", "steak")
...
def filter_foods_with_a():
    # your code here
    foods = ('Taco', 'Burrito', 'Sandwich', "Apple")
    #  .lower() to account for case sensitive
